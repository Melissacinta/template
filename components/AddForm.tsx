                ...
                <div key={field.name}>
                  ...
                  <div className="mt-1">
                    <input
                      ...
                      className="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:w-1/3 sm:text-sm"
                    />
                  </div>
                </div>
              ) : field.type === 'photo' ? (
